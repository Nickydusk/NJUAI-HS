...
public class TestLevelGeneration {
    ...
    public static void main(String[] args) {
		...
		String randomLevelGenerator = "core.levelGeneration.randomLevelGenerator.LevelGenerator";
		String geneticGenerator = "core.levelGeneration.geneticLevelGenerator.LevelGenerator";
		String constructiveLevelGenerator = "core.levelGeneration.constructiveLevelGenerator.LevelGenerator";
		...
		// String levelGenerator = "core.levelGeneration." + args[0] + ".LevelGenerator";
		// int numberOfLevels = 5;
		// core.levelGeneration.randomLevelGenerator.LevelGenerator.includeBorders = true;
