package core.levelGeneration.geneticLevelGenerator;
...
public class SharedData {
	 ...
	 */
	public static final String AGENT_NAME = "tracks.controllers.tools.repeatOLETS.Agent";
	/**
	 * The name of a naive agent
	 */
	public static final String NAIVE_AGENT_NAME = "tracks.controllers.methods.sampleonesteplookahead.Agent";
	/**
	 * The name of the do nothing agent
	 */
	public static final String DO_NOTHING_AGENT_NAME = "tracks.controllers.methods.doNothing.Agent";
	 ...
	 */
	public static core.levelGeneration.constructiveLevelGenerator.LevelGenerator constructiveGen;
